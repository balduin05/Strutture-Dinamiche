...
public class Esempio2 {
	...
	public static void main(String[] args) {
		...
		// 1) Contains()
		// 2) indexOf()
		// 3) firstElement()  Saranno molto utili quando faremo lo stack/queue
		// 4) lastElement()
		// 5) remove()

		System.out.println();
		System.out.println(" - RICERCA ELEMENTO: - ");
		System.out.println();

		System.out.println("Stampa primo elemento: " + v.firstElement());
		System.out.println("Stampa ultimo elemento: " + v.lastElement());

		v.remove(0);
		System.out.println(" - ELIMINA PRIMO ELEMENTO - ");
		System.out.println();
		System.out.println(v);
